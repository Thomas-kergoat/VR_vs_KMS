...
namespace vr_vs_kms
{
    public class ContaminationAreaGreg : MonoBehaviour
    {
        [System.Serializable]
        ...
        public List<PlayersGreg> playersOnPoint;
        ...
        void OnTriggerExit(Collider other)
        {
            ...
            {
                KMSCapturing = false;
                other.gameObject.GetComponent<PlayersGreg>().slider.gameObject.SetActive(false);
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            {
                KMSCapturing = true;
                playersOnPoint.Add(other.gameObject.GetComponent<PlayersGreg>());
                other.gameObject.GetComponent<PlayersGreg>().slider.gameObject.SetActive(true);
            }
            if (other.tag == "VRPlayer")
            {
                VRCapturing = true;
        ...
        void Update()
        {
            ...
            else if (VRCapturing)
            {
                ...
                foreach (PlayersGreg player in playersOnPoint)
                {
